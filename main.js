        ...
        output += `
          ...
          <div class="col-md-3">
            ...
            <h5>${movie.title}</h5>
              ...
              <a onclick="movieSelected('${movie.id}')" class="btn btn-primary" id="more" href="#">Movie Details</a>
            </div>
          </div>
      ...
      let output = `
        ...
        <div class="row">
          <div class="well">
            ...
            ${movie.overview}
            <hr>
            <a href="http://imdb.com/title/${movie.imdb_id}" target="_blank" id="more" class="btn btn-primary">View IMDB</a>
            <a href="pretraga.html" id="more" class="btn btn-default">Go Back To Search</a>
          </div>
        </div>
    `;
      $('#movie').html(output);
